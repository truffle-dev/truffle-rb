...
module Truffle
  module Providers
    ...
    class OpenAIStream
      ...
      # on toolcall_delta/partial. pi repairs partial JSON; we keep it simple and
      # return {} until the buffer parses, which it does once the call completes.
      ...
      # matching the non-streaming path in Providers::OpenAI.
